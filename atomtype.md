...
as depicted in Figure [10.1](#fig:methane).

<a name="fig:methane"></a>
![](images/methane.png)
<br />**Figure 10.1**: 3D structure of methane, showing a sp³ carbon surrounded byfour hydrogens. Image from Wikipedia: [File:Methane-CRC-MW-dimensions-2D.png](http://en.wikipedia.org/wiki/File:Methane-CRC-MW-dimensions-2D.png) (public domain).
...
For example, Figure [10.1](#fig:methane) showed one possible
